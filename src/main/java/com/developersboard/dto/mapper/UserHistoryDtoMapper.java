package com.developersboard.dto.mapper;
...
public interface UserHistoryDtoMapper {
  ...
  @Mapping(
      ...
      expression =
          "java(com.developersboard.util.core.DateUtils.getTimeElapsedDescription(userHistory.getCreatedAt()))")
  @Mapping(
      target = "separateDateFormat",
      expression =
          "java(com.developersboard.util.core.DateUtils.getTimeElapsed(userHistory.getCreatedAt()))")
